...
export class ManagerService {
  ...
  InventoryUrl = "http://localhost:5161/api/Inventories";
  ManagerUrl = "http://localhost:5161/api/Managers";
  DriverUrl = "http://localhost:5161/api/Drivers";
  CustomerUrl = "http://localhost:5161/api/Customers";
  VehicleUrl="http://localhost:5161/api/Vehicles";
  OrdersUrl = "http://localhost:5161/api/ViewsDisplay/OrderdetailsView";
  AllOrders="http://localhost:5161/api/Customers/GetAllOrders";
  ResourcesUrl = "http://localhost:5161/api/ViewsDisplay/ResurcesView";
  ShipmentUrl = "http://localhost:5161/api/ViewsDisplay/ShipmentsView";
